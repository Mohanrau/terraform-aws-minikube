module "minikube" {
  ...
  addons = [
    ...
    "https://raw.githubusercontent.com/mohanrau/terraform-aws-minikube/master/addons/csi-driver.yaml",
    "https://raw.githubusercontent.com/mohanrau/terraform-aws-minikube/master/addons/metrics-server.yaml",
